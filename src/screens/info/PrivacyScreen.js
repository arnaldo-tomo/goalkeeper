    ...
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.sectionText}>
          ...
          dados de perfil, metas, tarefas e preferências de uso.
        </Text>

        <Text style={styles.sectionTitle}>2. Como Usamos suas Informações</Text>
        <Text style={styles.sectionText}>
          Suas informações são usadas para personalizar sua experiência, fornecer 
          lembretes inteligentes e gerar análises de produtividade.
        </Text>

        <Text style={styles.sectionTitle}>3. Compartilhamento de Dados</Text>
        <Text style={styles.sectionText}>
          Não compartilhamos, vendemos ou alugamos suas informações pessoais para 
          terceiros. Seus dados permanecem privados e seguros.
        </Text>
        ...
        <Text style={styles.sectionText}>
          Para questões sobre privacidade, entre em contato: privacidade@goalkeeper.app
        </Text>
      </View>
    </ScrollView>
  );
